    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit_type', models.CharField(max_length=16, verbose_name='Credit Card Type', choices=[(b'Visa', 'Visa'), (b'Mastercard', 'Mastercard'), (b'Discover', 'Discover'), (b'American Express', 'American Express')])),
                ...
                ('orderpayment', models.OneToOneField(related_name='creditcards', to='shop.OrderPayment')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(help_text='Should this be displayed as an option for the user?', verbose_name='Active')),
                ('optionName', models.CharField(help_text='The class name as defined in payment.py', unique=True, max_length=20, verbose_name='Option Name', choices=[('DUMMY', 'Payment test module')])),
