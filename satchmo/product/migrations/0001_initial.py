    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_categories', models.ManyToManyField(related_name='related_categories_rel_+', verbose_name='Related Categories', to='product.Category', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(verbose_name='site', to='sites.Site')),
                ('valid_categories', models.ManyToManyField(to='product.Category', verbose_name='Valid Categories', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxable', models.BooleanField(default=product.models._taxable_by_default, verbose_name='Taxable')),
                ...
                ('also_purchased', models.ManyToManyField(related_name='also_purchased_rel_+', verbose_name='Previously Purchased', to='product.Product', blank=True)),
                ('category', models.ManyToManyField(to='product.Category', verbose_name='Category', blank=True)),
                ('related_items', models.ManyToManyField(related_name='related_items_rel_+', verbose_name='Related Items', to='product.Product', blank=True)),
                ('site', models.ForeignKey(verbose_name='Site', to='sites.Site')),
            ],
            options={
